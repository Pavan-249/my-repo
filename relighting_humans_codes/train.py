...
parser.add_argument('--train_dir', '-i', default='/content/my-repo/relighting_humans_codes/train_inputs', help='Directory for training input images')
parser.add_argument('--test_dir', '-t', default='/content/my-repo/relighting_humans_codes/test_inputs', help='Directory for test input images')
parser.add_argument('--out_dir', '-o', default='/content/my-repo/relighting_humans_codes/outputs', help='Directory for output images')
parser.add_argument('--train_light_dir', '-l0', default='/content/my-repo/relighting_humans_codes/train_lights', help='Light directory for training')
parser.add_argument('--test_light_dir', '-l1', default='/content/my-repo/relighting_humans_codes/test_lights', help='Light directory for test')
